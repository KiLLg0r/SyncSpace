...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const storageRef = ref(storage, `/users/${currentUser.displayName}/projects/${currentUser.displayName}`);
  ...
  useEffect(() => {
    if (Object.keys(data).length === 0) getUserData(currentUser.displayName).then((res) => setData(res));
  }, [data, currentUser]);
      ...
      <div className={styles.profileCard}>
        <div className={styles.img}>
          <div className={styles.imageContainer}>
            <div className={`${isEditing && styles.img} ${styles.imageEdit}`} onClick={imgRefClick}>
              <Image
            ...
            <div className={styles.icon} style={{ visibility: isEditing && "visible" }} onClick={imgRefClick}>
              <BsPencilSquare />
            </div>
            <input
              type="file"
